...
export default function GekuendigtContent({ entry, prev, next, yearData }: Props) {
  ...
  return (
    <main className="pb-20">
        ...
        <div className="max-w-content mx-auto">
          <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
            <div className="p-4">
              ...
              {/* Besonderer Kündigungsschutz — grauer Hintergrund, farbiger Balken */}
      ...
      {/* ═══ 4. Fakten-Box (2x2 Grid) — bg-gray-50, Kacheln weiß mit farbigem border-top ═══ */}
      <section className="py-3 px-4 sm:px-8 mb-3">
      ...
      {/* ═══ 10. CTA #2 — dezent, farbiger linker Balken ═══ */}
      <section className="py-3 px-4 sm:px-8 mb-3">
        <div className="max-w-content mx-auto">
