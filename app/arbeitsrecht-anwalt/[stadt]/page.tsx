...
export async function generateMetadata({
  ...
  const url = `https://www.gender-paygap.de/arbeitsrecht-anwalt/${ort.slug}/`;
...
function buildSchema(slug: string) {
  ...
  return {
    ...
    "@graph": [
      ...
      {
        "@type": "Person",
        "@id": "https://www.gender-paygap.de/#author",
      },
      {
        "@type": "FAQPage",
        "@id": `${url}#faq`,
      ...
      },
      {
        "@type": "BreadcrumbList",
        itemListElement: [
          { "@type": "ListItem", position: 1, name: "Startseite", item: "https://www.gender-paygap.de/" },
          { "@type": "ListItem", position: 2, name: "Arbeitsrecht Anwalt", item: "https://www.gender-paygap.de/arbeitsrecht-anwalt/" },
