      ...
      <main>
        ...
        <header className="pt-6 pb-[80px] px-8 bg-secondary-50 max-md:pb-[60px] max-md:px-6">
          <div className="max-w-content mx-auto">
            <div className="text-[0.72rem] font-bold tracking-[0.14em] uppercase text-secondary-700 mb-2.5">Arbeitnehmer · Entschädigung</div>
          ...
          <div className="max-w-content mx-auto max-w-[800px]">
            ...
            <FadeUp delay={1}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
                <div className="bg-secondary-50 border border-secondary/20 rounded p-6">
                  <div className="text-[0.7rem] font-bold tracking-[0.14em] uppercase text-secondary-700 mb-2">Komponente 1</div>
              ...
              <div className="bg-slate-50 border border-border-light rounded p-6 mb-8">
                ...
                <div className="space-y-2 mb-3">
                  ...
                  <div className="border-t border-border-light pt-2 flex justify-between text-[1.05rem] font-bold text-ink">
                    ...
                    <span className="text-secondary-700">ca. 23.800 €</span>
                  </div>
                </div>
