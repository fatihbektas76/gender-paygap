      ...
      <main>
        ...
        <header className="pt-6 pb-[80px] px-8 bg-accent-50 max-md:pb-[60px] max-md:px-6">
          <div className="max-w-content mx-auto">
            <div className="text-[0.72rem] font-bold tracking-[0.14em] uppercase text-accent-700 mb-2.5">Arbeitgeber · Tarifrecht</div>
            ...
            <FadeUp>
              ...
              <div className="overflow-x-auto">
                <table className="w-full border-collapse text-[0.92rem]">
                  <thead>
                    <tr>
                      <th className="text-left p-4 bg-accent-50 border border-border font-semibold text-ink w-[200px]">Aspekt</th>
                      <th className="text-left p-4 bg-accent-50 border border-border font-semibold text-ink">Tarifbeschäftigte</th>
                      <th className="text-left p-4 bg-accent-50 border border-border font-semibold text-ink">AT-Beschäftigte</th>
                    </tr>
                  </thead>
                  <tbody>
                    {[
