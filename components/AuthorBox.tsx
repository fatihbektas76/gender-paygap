  ...
  return (
    <aside className="mt-16 p-8 bg-slate-50 border border-border-light rounded flex gap-7 items-start max-md:flex-col max-md:items-center max-md:text-center">
      ...
      <div>
        ...
        <div className="text-[0.88rem] text-primary-700 font-semibold mb-3">
        ...
        <div className="flex items-center gap-4 max-md:justify-center flex-wrap">
          <a
            ...
            className="inline-flex items-center gap-1.5 text-[0.82rem] font-semibold text-primary hover:text-primary-700 no-underline transition-colors"
          >
