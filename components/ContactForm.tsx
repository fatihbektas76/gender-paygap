            ...
            <div>
              ...
              <div className="flex items-center gap-3 mb-3.5 text-[0.92rem] text-ink-light">
                ...
                <div>
                  ...
                  <br />
                  <a href="mailto:bektas@apos.legal" className="text-ink-light no-underline hover:text-primary transition-colors">
                    bektas@apos.legal
                  </a>
                </div>
              </div>
              <div className="flex items-center gap-3 mb-3.5 text-[0.92rem] text-ink-light">
                ...
                <div>
                  ...
                  <br />
                  <a href="tel:+49622295992400" className="text-ink-light no-underline hover:text-primary transition-colors">
                    +49 6222 9599 2400
                  </a>
                </div>
              </div>
              <div className="flex justify-center mt-5 mb-3.5">
                <a
                  ...
                  className="inline-flex items-center gap-2.5 py-3.5 px-8 border-2 border-primary bg-primary-50 text-primary-700 font-semibold text-[0.95rem] rounded-sm no-underline transition-all hover:bg-primary hover:text-white hover:-translate-y-px hover:shadow-[0_6px_20px_rgba(99,102,241,0.25)]"
                >
                  <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
              ...
              <div className="mt-6 py-4 px-5 bg-slate-50 rounded-sm border-l-[3px] border-primary">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4 max-md:grid-cols-1">
                    <div>
                      <label className="block text-[0.84rem] font-semibold text-ink mb-1.5">
                        Vollständiger Name <span className="text-primary-700 ml-0.5">*</span>
                      </label>
                      <input
                        type="text"
                        name="name"
                    ...
                    <div>
                      <label className="block text-[0.84rem] font-semibold text-ink mb-1.5">
                        E-Mail <span className="text-primary-700 ml-0.5">*</span>
                      </label>
                      <input
                        type="email"
                        name="email"
                  ...
                  <div className="mb-4">
                    <label htmlFor="audience" className="block text-[0.84rem] font-semibold text-ink mb-1.5">
                      Ich bin <span className="text-primary-700 ml-0.5">*</span>
                    </label>
                    <select
                      id="audience"
                      name="audience"
                  ...
                  <div className="mb-4">
                    <label className="block text-[0.84rem] font-semibold text-ink mb-1.5">
                      Ihre Nachricht <span className="text-primary-700 ml-0.5">*</span>
                    </label>
                    <textarea
                      name="message"
                      ...
                      required
                      className="w-full py-3 px-4 border border-border rounded-sm font-sans text-[0.92rem] text-ink bg-white transition-all outline-none resize-y min-h-[120px] focus:border-primary focus:shadow-[0_0_0_3px_rgba(99,102,241,0.1)] placeholder:text-ink-muted"
                    />
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full py-3.5 bg-primary text-white border-none rounded-sm font-sans text-base font-semibold cursor-pointer transition-all mt-2 hover:bg-primary-700 hover:-translate-y-px hover:shadow-[0_6px_20px_rgba(99,102,241,0.25)] disabled:opacity-60 disabled:cursor-not-allowed disabled:transform-none disabled:shadow-none"
                  >
